...
-- CreateEnum
CREATE TYPE "public"."Day" AS ENUM ('SATARDAY', 'SUNDAY', 'MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'RFIDAY');
...
-- CreateIndex
CREATE UNIQUE INDEX "Lesson_name_key" ON "public"."Lesson"("name");
...
-- AddForeignKey
ALTER TABLE "public"."Result" ADD CONSTRAINT "Result_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "public"."Student"("id") ON DELETE SET NULL ON UPDATE CASCADE;
