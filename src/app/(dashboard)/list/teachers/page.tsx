...
import { Class, Subject, Teacher, PrismaClient } from '@/generated/prisma'
...
const renderRow = (item: TeacherList) => {
  ...
  return (
    <tr key={item.id}>
      <td>
        <Image src={item.img || "/noAvatar.png"} alt='' width={40} height={40} className='hidden md:block w-10 h-10 rounded-full object-cover' />
