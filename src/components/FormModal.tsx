...
const FormModal = ({ table, type, data, id }: { table: | "teacher" | "student" | "parent" | "subject" | "class" | "lesson" | "exam" | "assignment" | "result" | "attendance" | "envet" | "announcement"; type: 'create' | 'update' | 'delete', data?: any, id?: number }) => {
