...
const ExamForm = ({ type, data,setOpen }: { type: "create" | "update", data?: any,setOpen: Dispatch<SetStateAction<boolean>> }) => {
    ...
    return (
        <form className='flex flex-col gap-8' onSubmit={onSubmit}>
            ...
            <div className='flex flex-row flex-wrap justify-between gap-2'>
                ...
                <InputField label='Date' name='date' type='date' defaultValue={data?.teacher} register={register} error={errors.date} className='md:w-1/3' />
