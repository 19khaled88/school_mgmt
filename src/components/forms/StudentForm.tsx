    ...
    return (
        <form className='flex flex-col gap-8' onSubmit={onSubmit}>
            ...
            <div className='flex flex-wrap justify-between gap-4'>
                ...
                <InputField label='Blood Type' name='bloodType' type='text' defaultValue={data?.bloodType} register={register} error={errors.bloodType} className='md:w-1/4'/>
                <InputField label='Birthday' name='birthday' type='date' defaultValue={data?.birthday} register={register} error={errors.birthday} className='md:w-1/4'/>
