    ...
    return (
        <form className='flex flex-col gap-8' onSubmit={onSubmit}>
            ...
            <div className='flex flex-wrap justify-between gap-4'>
                ...
                <InputField label='Address' name='address' type='text' defaultValue={data?.address} register={register} error={errors.address} />
                <InputField label='Blood Type' name='bloodType' type='text' defaultValue={data?.bloodType} register={register} error={errors.bloodType} />
